...
<body>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php
            include "connect.php";
            $qry_siswa=mysqli_query($conn,"select * from siswas join kelas on kelas.id_kelas=siswas.id_kelas");
            $no = 0;
            while ($data_siswa = mysqli_fetch_array($qry_siswa)) {
                ...
                <tr>
                    ...
                    <td><?= $data_siswa['nama_kelas'] ?></td> <td><a href="ubah_siswa.php?id_siswa=<?= $data_siswa['id_siswa'] ?>"
